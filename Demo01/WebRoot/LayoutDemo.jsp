...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		...
		<font color="#FFFFFF" size="100px">东至县城乡居保中心|<font
			color="#FFFFFF" size="100px">档案管理系统</font>
		</font>
	</div>
	...
	<div data-options="region:'west',split:true,title:'档案分类'"
		...
		<div class="easyui-panel" style="padding:0px;width:100%;height: 100%">
			<ul class="easyui-tree" id='allTree'>
				<li><span>业务档案</span>
					<ul>
						<li data-options="state:'open'"><span>管理类</span>
							<ul>
								<li><span id='cbdjl'>参保登记类</span></li>
								<li><span id='xxbgl'>信息变更类</span></li>
								<li><span id='gxzyl'>关系转移接续类</span></li>
								<li><span>社会保险卡管理类</span></li>
								<li><span>服务协议管理类</span></li>
								<li><span>其他类</span></li>
							</ul></li>
						<li data-options="state:'open'"><span>待遇类</span>
							<ul>
								<li><span>待遇核定类</span></li>
								<li><span>待遇支付类</span></li>
								<li><span>待遇领取资格认证类</span></li>
								<li><span>待遇停止支付类</span></li>
								<li><span>待遇恢复支付类</span></li>
								<li><span>待遇调整类</span></li>
								<li><span>关系终止类</span></li>
								<li><span>基金支出支付年度表类</span></li>
							</ul></li>
						<li><span>稽核类</span>
							<ul>
								<li>稽核类</li>
						...
						<li data-options="state:'open'"><span>统计类</span>
							<ul>
								<li><span>统计报表类</span></li>
								<li><span>数据和分析报告类</span></li>

							</ul></li>
						<li data-options="state:'open'"><span>征缴类</span>
							<ul>
								<li><span>正常缴费类</span></li>
								<li><span>补缴类</span></li>
								<li><span>集体补助或资助类</span></li>
								<li><span>财政补贴类</span></li>
								<li><span>基金征缴年度汇总类</span></li>
							</ul></li>
				...
				<li data-options="state:'closed'"><span>文书档案</span>
					<ul>
						<li><span>综合部门</span></li>
						<li><span>保险费收缴部门</span></li>
						<li><span>待遇支付部门</span></li>
						<li><span>信息管理部门</span></li>
						<li><span>稽核部门</span></li>
						<li><span>被征地农民养老保险管理部门</span></li>
					</ul></li>
				...
				<li data-options="state:'closed'"><span>会计档案</span>
					<ul>
						<li><span>凭证类</span></li>
						<li><span>账簿类</span></li>
						<li><span>报表类</span></li>
				...
				<li data-options="state:'closed'"><span>科技档案</span>
					<ul>
						<li><span>基建类</span></li>
						<li><span>设备类</span></li>
					</ul></li>
				...
				<li data-options="state:'closed'"><span>声像档案</span>
					<ul>
						<li><span>照片类</span></li>
						<li><span>录音类</span></li>
						<li><span>录像类</span></li>
				...
				<li data-options="state:'closed'"><span>电子类</span>
					<ul>
						<li><span>移动硬盘类</span></li>
						<li><span>光盘类</span></li>
						<li><span>磁盘类</span></li>
					</ul></li>


				<li data-options="state:'closed'"><span>实物档案</span>
					<ul>
						<li><span>锦旗类</span></li>
						<li><span>奖状奖牌类</span></li>
						<li><span>奖杯类</span></li>
						<li><span>印章类</span></li>
						<li><span>其它类</span></li>
					</ul></li>
 ...
 -->
	...
	<div id="xiugaishuju" class="easyui-window" title="请务必仔细核对填写！"
		...
		<div style="padding:10px 10px 10px 10px;align:center">
			<form id="xiugaiform" method="post" style="align:center">
				<table cellpadding="8">
					<tr>
						<td>关键信息:</td>
						<td><input type="text" style="width: 350px" id="keyinfo"
							name="detail1" data-options=""></input>
						</td>
					</tr>
					<tr>
						<td>档案编号:</td>
						<td><input type="text" style="width: 350px"
							id="danganbianhao1" name="danghao1" data-options=""></input>
						</td>
					</tr>
					<tr>
						<td>页 码:</td>
						<td><input type="text" style="width: 350px" id="code"
							name="code1" data-options=""></input>
						</td>
					</tr>
					<tr>
						<td>唯一标识:</td>
						<td><input type="text" style="width: 350px" id="onlyid1"
							name="onlyid1" readonly="readonly"></input>
						</td>
					</tr>
				</table>
			</form>
			...
			<script type="text/javascript">
	      	...
	      	var detail1=$('#keyinfo').val();
	      	var danghao1=$('#danganbianhao1').val();
	      	var code1=$('#code').val();
	      	var onlyid1=$('#onlyid1').val();
	      	
	      
	      	$.ajax(
	        							{
	        							url:"servlet/XiugaiServlet?random="+Math.random()+"&detail1="+encodeURI(detail1,'utf-8')+"&danghao1="+encodeURI(danghao1,'utf-8')+"&code1="+encodeURI(code1,'utf-8')+"&onlyid1="+encodeURI(onlyid1,'utf-8'),
	        							async:true,
	        							type:"post",
	        							 contentType:"application/x-www-form-urlencoded:charset=UTF-8",
 ...
 -->
	...
	<div
		data-options="region:'east',split:true,collapsed:false,title:'档案检索'"
		style="width:330px;padding:1px;">
		...
		<div style="text-align:center">
				...
				<table cellpadding="4">
					<tr>
						...
						<td><input class="easyui-textbox" type="text"
							name="danganbianhao" style="width:150px"></input>
						</td>
					</tr>
					<tr>
						<td>年 份:</td>
						<td><select class="easyui-combobox" name="nianfen"
							style="width:150px">
					...
					<tr>
						<td>乡 镇:</td>
						<td><select class="easyui-combobox" name="xiangzhen"
							style="width:150px">
								<option value="东流镇">东流镇</option>
								<option value="尧渡镇">尧渡镇</option>
								<option value="大渡口镇">大渡口镇</option>
								<option value="花园乡">花园乡</option>
								<option value="胜利镇">胜利镇</option>
								<option value="香隅镇">香隅镇</option>
								<option value="木塔乡">木塔乡</option>
								<option value="张溪镇">张溪镇</option>
								<option value="龙泉镇">龙泉镇</option>
								<option value="泥溪镇">泥溪镇</option>
								<option value="葛公镇">葛公镇</option>
								<option value="官港镇">官港镇</option>
								<option value="洋湖镇">洋湖镇</option>
								<option value="青山乡">青山乡</option>
								<option value="昭潭镇">昭潭镇</option>
					...
					<tr>
						<td>是否缺材料:</td>
						<td><select class="easyui-combobox" name="shifouquecailiao"
							style="width:150px">
								<option value="">忽视</option>
								<option value="缺材料">缺材料</option>
								<option value="buque">不缺材料</option>
			...
			<div style="text-align:center;padding:5px">
				<a href="javascript:void(0)" class="easyui-linkbutton"
					onclick="submitForm()">开始查找</a> <a href="javascript:void(0)"
					class="easyui-linkbutton" onclick="clearForm()">清除条件</a>
			</div>
		</div>
		<script>
		function submitForm(){
			/* $('#ff').form('submit'); */
			var danganbianhao=$("input[name='danganbianhao']").val()  ;
			var xiangzhen=$("input[name='xiangzhen']").val()  ;
			var nianfen=$("input[name='nianfen']").val()  ;
			var shifouquecailiao=$("input[name='shifouquecailiao']").val()  ;
			
 		 $('#list_data').datagrid({
		 
		 url:"servlet/SearchByXiangZhengAndNianfen?random="+Math.random()+"&danganbianhao="+encodeURI(danganbianhao,'utf-8')
		 +"&xiangzhen="+encodeURI(xiangzhen,'utf-8')+"&nianfen="+encodeURI(nianfen,'utf-8')+"&shifouquecailiao="+encodeURI(shifouquecailiao,'utf-8'),
    ...
    $(p).pagination({ 
		...
		<!--饼图 -->
		<div id="bingtu" style="min-width:300px;height:300px;align:center"></div>
	...
	<div data-options="region:'center',title:'详细信息'"
		...
		<div style="1300px ;text-align:center">
			<div>
				<table headerRows='1' id="list_data" title="卷内文件目录"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'dept',width:110">操作者</th>
							<th data-options="field:'detail',width:375">详细信息</th>
							<th data-options="field:'zhenglidate',width:100">日 期</th>
							<th data-options="field:'code',width:65">页 码</th>
							<th data-options="field:'ps',width:100">备 注</th>
							<th data-options="field:'danghao',width:180">档 号</th>
							<th data-options="field:'dangantype',width:70">档案类型</th>
							<th data-options="field:'townid',width:50">乡镇</th>
							
							<th data-options="field:'niandu',width:60">年 度</th>
							<th data-options="field:'onlyid',width:60">唯一标识</th>
